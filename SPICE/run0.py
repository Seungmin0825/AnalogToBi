...
circuit.MOSFET('NM5', 'x14', 'VREF1', 'x17', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'x3', 'x24', 'x64', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM2', 'x64', 'x11', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM12', 'x27', 'VB4', 'x33', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM14', 'VIN1', 'x41', 'VOUT1', 0, model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x3', 'VB3', 'x14', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
