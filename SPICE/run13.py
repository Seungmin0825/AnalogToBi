...
circuit.MOSFET('NM4', 'x103', 'x120', 'x110', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM11', 'x50', 'x116', 'IB1', 'IB1', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM14', 'VIN1', 'x109', 'VOUT1', 'VOUT1', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x117', 'x103', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x116', 'x105', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM12', 'x110', 'x116', 'x44', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.R('R4', 'x120', 'VSS', 1@u_kΩ)
circuit.R('R1', 'x32', 'x35', 1@u_kΩ)
circuit.R('R2', 'VOUT1', 'VSS', 1@u_kΩ)
circuit.R('R5', 'VOUT1', 'x120', 1@u_kΩ)
