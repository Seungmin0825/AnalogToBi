...
circuit.MOSFET('NM4', 'VOUT1', 'x10', 'x5', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM12', 'x5', 'VB7', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM13', 'x3', 'VB6', 'x5', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'x5', 'VOUT1', 0, 'VDD', model='pmos_model', w=50e-6, l=1e-6)
