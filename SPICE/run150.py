...
circuit.MOSFET('NM4', 'x17', 'x18', 'x2', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM8', 'x37', 'x35', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM9', 'x38', 'VB4', 'x37', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM10', 'VB4', 'VB4', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM11', 'VIN1', 'x17', 'VOUT1', 'VOUT1', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x2', 'VSS', 'x10', 'x62', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x30', 'VREF1', 'x10', 'x62', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM9', 'x35', 'x38', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM11', 'VB4', 'x38', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
