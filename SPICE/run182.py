...
# Nets
circuit.C('C2', 'x107', 'VOUT1', 1@u_pF)
circuit.C('C1', 'x111', 'VSS', 1@u_pF)
...
circuit.MOSFET('NM14', 'x112', 'VB6', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM15', 'x107', 'VB5', 'x112', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x111', 'VB2', 'x102', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x107', 'VB2', 'x100', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM9', 'x112', 'x111', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM10', 'VOUT1', 'x107', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
