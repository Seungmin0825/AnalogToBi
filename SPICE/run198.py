...
circuit.MOSFET('NM4', 'x100', 'VOUT2', 'x109', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'x102', 'VREF1', 'x109', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM5', 'x109', 'VB1', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM10', 'VOUT2', 'x122', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'VOUT2', 'x100', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'VOUT2', 'x102', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM13', 'x17', 'VOUT2', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM12', 'VIN1', 'VB2', 'x17', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
