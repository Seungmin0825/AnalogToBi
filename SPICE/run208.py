...
circuit.MOSFET('NM3', 'VSS', 'VREF1', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'VSS', 'VSS', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM5', 'VSS', 'VSS', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM12', 'VIN1', 'VSS', 'VOUT1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM11', 'VSS', 'VSS', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM17', 0, 'VSS', 0, 0, model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'x5', 'VSS', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'VSS', 'VSS', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM12', 'VSS', 0, 0, 0, model='pmos_model', w=50e-6, l=1e-6)
...
circuit.R('R6', 'VSS', 'VSS', 1@u_kΩ)
circuit.R('R7', 'VSS', 'VSS', 1@u_kΩ)
