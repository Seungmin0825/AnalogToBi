...
circuit.MOSFET('NM2', 'x120', 'x115', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM11', 'x50', 'x120', 'IB1', 'IB1', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM14', 'VIN1', 'x109', 'VOUT1', 'VOUT1', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x120', 'x105', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x115', 'x103', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM12', 'x110', 'x120', 'x44', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
