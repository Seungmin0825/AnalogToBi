...
circuit.MOSFET('NM7', 'VB1', 'VB1', 'VB1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM5', 'VB1', 'x105', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'x22', 'VREF1', 'VB1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM11', 'VDD', 'VB1', 'VB1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM13', 'VDD', 'VB1', 'VDD', 0, model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM10', 'VB1', 'VIN1', 'VB1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM12', 'VIN1', 'VIN1', 'VB1', 'VOUT1', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'x8', 'VIN1', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM10', 'VDD', 'VIN1', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM11', 'VIN1', 'VB1', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM9', 'VB2', 'VB2', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.R('R3', 'VB1', 'VSS', 1@u_kΩ)
circuit.R('R1', 'VDD', 'VSS', 1@u_kΩ)
circuit.R('R2', 'x46', 'VSS', 1@u_kΩ)
circuit.R('R4', 'VOUT1', 'VB1', 1@u_kΩ)
