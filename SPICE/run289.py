...
circuit.MOSFET('NM4', 'x107', 'x101', 'x105', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'x101', 'VREF1', 'x105', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM5', 'x105', 'x16', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM15', 'VIN1', 'x10', 'VOUT1', 'VOUT1', model='nmos_model', w=50e-6, l=1e-6)
