...
circuit.MOSFET('NM14', 'x112', 'VB8', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM15', 'x107', 'VB7', 'x112', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM11', 'x107', 'VB6', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
