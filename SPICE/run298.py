...
circuit.MOSFET('NM2', 'x101', 'x102', 'x22', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM1', 'x101', 'x102', 'x20', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'x109', 'x18', 'x112', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM8', 'x32', 'x102', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM9', 'x102', 'x102', 'x32', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM3', 'x101', 'VB1', 'x16', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM7', 'x16', 'x109', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM9', 'x102', 'x36', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
