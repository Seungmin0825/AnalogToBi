...
circuit.MOSFET('NM4', 'x5', 'x10', 'x5', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM14', 'VIN1', 'x5', 'VOUT1', 'VOUT1', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x5', 'VB2', 'x12', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
