...
# Nets
circuit.MOSFET('NM8', 'VOUT2', 'VDD', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM13', 'x3', 'VB3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM4', 'x12', 'x10', 'x26', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM6', 'x25', 'x25', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'VOUT1', 'x3', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM12', 'x3', 'x3', 'x59', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM10', 'VDD', 'x10', 'x55', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM5', 'x25', 'VB1', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM6', 'VB1', 'VB1', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM11', 'x55', 'VB2', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM13', 'x59', 'x10', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
