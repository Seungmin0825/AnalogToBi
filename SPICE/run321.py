...
# Nets
circuit.C('C1', 'VOUT1', 'x121', 1@u_pF)
circuit.C('C3', 'VB2', 'VB2', 1@u_pF)
circuit.C('C2', 'VOUT1', 'VB2', 1@u_pF)
circuit.MOSFET('NM3', 'VB2', 'x121', 'VB1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'VB2', 'VB2', 'VB1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM11', 'VB2', 'VB3', 'VB1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM10', 'VB1', 'VB2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM5', 'VB1', 'x107', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM16', 0, 'VB2', 0, 0, model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'VB2', 'VB2', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.R('R2', 'x121', 'VSS', 1@u_kΩ)
circuit.R('R3', 'VOUT1', 'x121', 1@u_kΩ)
