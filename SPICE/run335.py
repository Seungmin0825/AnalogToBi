...
circuit.MOSFET('NM5', 'x16', 'x2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'x10', 'VREF1', 'x16', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'x25', 'x10', 'x16', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM1', 'x6', 'x6', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM2', 'x41', 'x6', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM11', 'x45', 'VB2', 'x40', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'x40', 'x41', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
