...
circuit.MOSFET('NM4', 'x16', 'x24', 'x11', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'x13', 0, 0, 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x16', 'VB2', 'x16', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM7', 'VB3', 'x16', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM8', 'x11', 'x16', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM9', 'VOUT1', 'x16', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
