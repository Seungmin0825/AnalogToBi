...
circuit.MOSFET('NM2', 'x39', 'x100', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'x10', 'VREF1', 'x10', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'x11', 'x10', 'x10', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM9', 'VB2', 'VSS', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x39', 'x10', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
