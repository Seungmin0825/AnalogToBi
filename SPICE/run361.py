...
circuit.MOSFET('NM4', 'x2', 'x48', 'x14', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM1', 'x3', 'x3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM2', 'x46', 'x3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x46', 'x21', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
