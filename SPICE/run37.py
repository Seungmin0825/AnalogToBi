...
circuit.MOSFET('NM4', 'x101', 'x102', 'x115', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x102', 'x114', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x102', 'x101', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM12', 'x10', 'x102', 'x68', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM10', 'VOUT2', 'x12', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM14', 'x12', 'x12', 'x72', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM13', 'x68', 'VB4', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM15', 'x72', 'x102', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
