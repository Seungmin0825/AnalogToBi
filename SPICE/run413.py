...
circuit.MOSFET('NM5', 'x10', 'VB3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'VB3', 'VIN1', 'x10', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM2', 'VB3', 'x134', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM1', 'x134', 'x134', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'VB3', 'VB3', 'x119', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM12', 'x119', 'VB2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM6', 'VB1', 'VB3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM8', 'x105', 'VB3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM14', 'x57', 'VB3', 0, 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM20', 'VB3', 0, 0, 0, model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM18', 'VB3', 'VB3', 'VB3', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'VB3', 'VB3', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x134', 'VB3', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM9', 'VOUT1', 'x127', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM10', 'x127', 'x125', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM11', 'x125', 'x125', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM6', 'VB3', 'x105', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM16', 'VB3', 'VB4', 'VIN1', 0, model='pmos_model', w=50e-6, l=1e-6)
circuit.R('R1', 'VIN1', 'VB3', 1@u_kΩ)
circuit.R('R2', 'VIN1', 'VIN1', 1@u_kΩ)
