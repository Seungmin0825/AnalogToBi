...
circuit.MOSFET('NM2', 'x14', 'x5', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM8', 'x25', 'x30', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM9', 'x30', 'x30', 'VB2', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM12', 'x50', 0, 0, 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x14', 'x14', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM3', 'x14', 'x14', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM6', 'x26', 'x25', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM8', 'x30', 'x25', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM10', 'x44', 'x14', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.R('R1', 'VB2', 'x30', 1@u_kΩ)
circuit.R('R2', 0, 'x30', 1@u_kΩ)
