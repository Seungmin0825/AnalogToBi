...
circuit.MOSFET('NM2', 'x45', 'x3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x45', 'x21', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
