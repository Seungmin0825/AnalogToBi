...
circuit.MOSFET('NM2', 'VB2', 'x5', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'VB2', 'x10', 'VB2', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM11', 'VB2', 'VB2', 0, 0, model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM12', 'VB2', 0, 'VOUT1', 0, model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'VB2', 'VB3', 'x12', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x5', 'VB3', 'x12', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
