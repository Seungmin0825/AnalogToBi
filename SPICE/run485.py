...
circuit.MOSFET('NM5', 'x14', 'VB2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM4', 'VOUT1', 'x8', 'x14', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM8', 'x32', 'x40', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM10', 'VB2', 'x40', 'x42', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM9', 'x40', 'x40', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM6', 'VB2', 'x32', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
