...
circuit.MOSFET('NM4', 'x22', 'x101', 'x25', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM10', 'VOUT2', 'x10', 'x44', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM9', 'x40', 'x10', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'VOUT2', 'VB2', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM12', 'VB2', 'VB2', 'x64', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM11', 'VIN1', 'VB2', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM13', 'x64', 'x101', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.R('R2', 'VDD', 'x40', 1@u_kΩ)
circuit.R('R1', 'x44', 'VSS', 1@u_kΩ)
