...
circuit.MOSFET('NM2', 'x2', 'x5', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM12', 'VIN1', 'x3', 'VOUT1', 'VOUT1', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x3', 'VB2', 'x12', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x5', 'VB2', 'x14', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
