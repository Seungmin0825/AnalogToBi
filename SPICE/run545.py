...
circuit.MOSFET('NM3', 'x29', 'x12', 'x13', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM8', 'x22', 'VB4', 'x21', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x13', 'VREF1', 'x25', 'x47', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x18', 'x46', 'x25', 'x47', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM4', 'x29', 'VB3', 'x28', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM5', 'x11', 'VB3', 'x30', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
