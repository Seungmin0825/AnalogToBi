...
circuit.MOSFET('NM8', 'x2', 'x32', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM2', 'x42', 'x7', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM9', 'x32', 'x32', 'x38', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x42', 'x24', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'x41', 'x42', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
