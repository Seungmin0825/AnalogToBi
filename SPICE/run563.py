...
circuit.MOSFET('NM4', 'x2', 'x37', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM5', 'VSS', 'x23', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM8', 'VSS', 'VSS', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM10', 'VDD', 'VSS', 'VDD', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x5', 'VSS', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM10', 'VSS', 0, 'VSS', 0, model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM9', 'VSS', 0, 'VDD', 0, model='pmos_model', w=50e-6, l=1e-6)
circuit.R('R4', 'x37', 'VSS', 1@u_kΩ)
circuit.R('R1', 'VDD', 'VSS', 1@u_kΩ)
circuit.R('R2', 'VOUT1', 'VSS', 1@u_kΩ)
circuit.R('R5', 'VOUT1', 'x37', 1@u_kΩ)
