...
circuit.MOSFET('NM3', 'VSS', 'VREF1', 'x14', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM4', 'VOUT1', 'x60', 'x14', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM11', 'VIN1', 'VSS', 'VOUT1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'VSS', 'VSS', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x5', 'VOUT1', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'VSS', 'x47', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM9', 0, 'VSS', 0, 0, model='pmos_model', w=50e-6, l=1e-6)
circuit.R('R2', 'x60', 'VSS', 1@u_kΩ)
circuit.R('R1', 'VDD', 'x36', 1@u_kΩ)
circuit.R('R3', 'VOUT1', 'VSS', 1@u_kΩ)
circuit.R('R5', 'VOUT1', 'x60', 1@u_kΩ)
