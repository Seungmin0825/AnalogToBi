...
circuit.MOSFET('NM9', 'VIN1', 'x6', 'VOUT1', 'VOUT1', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x10', 'VREF1', 'x12', 'x63', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x13', 'x65', 'x12', 'x63', model='pmos_model', w=50e-6, l=1e-6)
