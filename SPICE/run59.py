...
circuit.MOSFET('NM2', 'VB4', 'x11', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'x50', 'x13', 'VB4', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'x11', 'VB6', 'VB4', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'VB4', 'x50', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
