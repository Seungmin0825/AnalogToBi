...
circuit.MOSFET('NM2', 'x100', 'x48', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'x48', 'VB6', 'x100', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x3', 'VB3', 'x12', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x48', 'VB3', 'x14', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM10', 'x48', 'VB5', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
