...
circuit.MOSFET('NM4', 'x24', 'VOUT1', 'x14', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x4', 'VOUT1', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x2', 'x24', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
