...
circuit.MOSFET('NM3', 'VOUT2', 'VB3', 'x100', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM2', 'VIN1', 'x101', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM4', 'VOUT2', 'VB3', 'VIN1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM7', 'VB3', 'VB3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM5', 'VB3', 'VB3', 'x101', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM5', 'VOUT2', 'VB2', 'x18', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'VIN1', 'VOUT2', 'VOUT2', 'x10', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x100', 'VREF1', 'VOUT2', 'x10', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM7', 'x18', 'VOUT2', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM16', 'VOUT2', 0, 0, 0, model='pmos_model', w=50e-6, l=1e-6)
