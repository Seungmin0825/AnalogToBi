...
# Nets
circuit.D('DIO1', 0, 'VB3', model='default')
circuit.MOSFET('NM11', 'VOUT2', 'VOUT2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM2', 'VB5', 'x125', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM1', 'VB5', 'x125', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM3', 'x116', 'VB5', 'VB5', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM12', 'VOUT1', 'VB5', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'VIN1', 'VB5', 'VB5', 'x16', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM4', 'x116', 'VB2', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM6', 'VIN1', 'x116', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM5', 'VB5', 'VB2', 'x115', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM7', 'x115', 'x116', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM8', 'VB5', 'VOUT2', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM15', 'VB5', 'VOUT2', 'VB5', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM17', 'VB5', 'VB5', 'VIN1', 'VB5', model='pmos_model', w=50e-6, l=1e-6)
