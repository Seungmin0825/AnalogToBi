...
circuit.MOSFET('NM8', 'VB2', 'x2', 'x2', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM5', 'x21', 'x24', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM4', 'VSS', 'VSS', 'x21', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'x12', 'VSS', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
