...
circuit.MOSFET('NM8', 'x32', 'VDD', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM9', 'VDD', 'VDD', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM10', 'x40', 'VDD', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'VDD', 'x40', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
