...
circuit.MOSFET('NM4', 'VB5', 'x24', 'VB5', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM1', 'x5', 'VB5', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'VB5', 'x24', 'x5', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
