...
circuit.MOSFET('NM4', 'x58', 'x3', 'x13', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM5', 'x58', 'VB2', 'x35', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x10', 'VREF1', 'x12', 'x61', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x13', 'x60', 'x12', 'x61', model='pmos_model', w=50e-6, l=1e-6)
