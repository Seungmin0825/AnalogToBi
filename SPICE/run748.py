...
# Nets
circuit.C('C1', 'x120', 'VSS', 1@u_pF)
circuit.C('C2', 'x59', 'VOUT1', 1@u_pF)
circuit.MOSFET('NM4', 'x102', 'x10', 'x118', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM3', 'x10', 'VREF1', 'x118', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM5', 'x118', 'x109', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM9', 'x37', 'x100', 'x41', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM11', 'x100', 'x100', 'x37', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'x121', 'x102', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM6', 'x109', 'x32', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM7', 'x32', 'x32', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM8', 'x100', 'VB2', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM9', 'x39', 'VB2', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM12', 'x54', 'x120', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
