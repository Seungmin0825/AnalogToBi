...
circuit.MOSFET('NM2', 'x47', 'x7', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM10', 'x40', 'x32', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'x47', 'x24', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'x32', 'x40', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.R('R3', 'x10', 'VSS', 1@u_kΩ)
circuit.R('R1', 'VDD', 'x32', 1@u_kΩ)
circuit.R('R4', 'x26', 'VSS', 1@u_kΩ)
