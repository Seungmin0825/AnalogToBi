...
circuit.MOSFET('NM2', 'x102', 'x49', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'x49', 'VB6', 'x102', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x101', 'VB3', 'x12', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x49', 'VB3', 'x14', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
