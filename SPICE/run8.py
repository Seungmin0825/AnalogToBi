...
circuit.MOSFET('NM3', 'VSS', 'VREF1', 'VOUT1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM8', 'VB2', 'VOUT1', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM15', 'VSS', 'VB5', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM16', 'VOUT1', 'VOUT1', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM17', 'VOUT1', 0, 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM18', 'VIN1', 'VIN1', 'VSS', 0, model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM9', 'VOUT2', 'VOUT1', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM2', 'VOUT1', 'VSS', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM12', 'VSS', 'VSS', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM14', 'VIN1', 'VB4', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM16', 'VOUT1', 'VOUT1', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM15', 'VOUT1', 'VOUT1', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM17', 'VOUT1', 'VOUT1', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM18', 'VOUT1', 'VOUT1', 'VIN1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
