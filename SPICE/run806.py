...
circuit.MOSFET('NM3', 'VOUT1', 'x10', 'x6', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'VOUT1', 'VB6', 'VOUT1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
