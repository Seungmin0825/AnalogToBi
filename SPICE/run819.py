...
circuit.MOSFET('NM2', 'VB2', 'x113', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'VB2', 'VSS', 'x102', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM12', 'VB2', 'VB3', 'x117', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM4', 'VB2', 'VREF1', 'x102', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM5', 'x102', 'x100', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM8', 'x43', 'VB2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM9', 'x124', 'VB2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM17', 'VB2', 0, 0, 0, model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'VB2', 'VB2', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM7', 'VOUT1', 'x124', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM8', 'x124', 'VB2', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'x113', 'VB2', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM6', 'x100', 'VB1', 'VIN1', 'VIN1', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM17', 'VB2', 0, 0, 0, model='pmos_model', w=50e-6, l=1e-6)
