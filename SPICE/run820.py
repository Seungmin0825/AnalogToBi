...
circuit.MOSFET('NM2', 'x43', 'x100', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'x51', 'x101', 'x43', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'x100', 'VB6', 'x43', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x51', 'VB3', 'x15', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x100', 'VB3', 'x17', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
