...
circuit.MOSFET('NM5', 'VSS', 'x2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'x20', 'VREF1', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM4', 'x89', 'x45', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'VIN1', 'x5', 'VSS', 'VOUT1', model='nmos_model', w=50e-6, l=1e-6)
