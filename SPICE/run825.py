...
circuit.MOSFET('NM4', 'x17', 'x18', 'x3', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM7', 'x40', 'VB6', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM8', 'x44', 'VB5', 'x40', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x3', 'x2', 'x10', 'x8', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM10', 'x40', 'x17', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM11', 'VOUT1', 'x44', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM12', 'x44', 0, 0, 0, model='pmos_model', w=50e-6, l=1e-6)
