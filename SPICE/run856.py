...
circuit.MOSFET('NM4', 'x101', 'x24', 'VB4', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM1', 'x5', 'VB4', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'VB4', 'x24', 'x5', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM10', 'VB4', 'VB4', 'VB4', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'VB4', 'VB7', 'VB4', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM8', 'VB4', 'x101', 'VOUT1', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM9', 'VOUT1', 'VB4', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM10', 'VB4', 'VB5', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.R('R3', 'x15', 'VSS', 1@u_kΩ)
circuit.R('R1', 'VB4', 'VSS', 1@u_kΩ)
circuit.R('R2', 'VB4', 'VSS', 1@u_kΩ)
