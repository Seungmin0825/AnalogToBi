...
circuit.MOSFET('NM5', 'VDD', 'x104', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'x114', 'VREF1', 'VDD', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM2', 'VDD', 'x125', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM1', 'x125', 'x125', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'x10', 'x11', 'VDD', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM9', 'x101', 'VB1', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM10', 'VB1', 'VB2', 'x101', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM14', 'VDD', 'VB3', 'IB1', 'IB1', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM12', 'VDD', 0, 'x93', 0, model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM5', 'x104', 'VB1', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'VDD', 'x114', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x125', 'x10', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM13', 'VDD', 'VB2', 'VB3', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
