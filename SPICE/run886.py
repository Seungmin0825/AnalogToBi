...
circuit.MOSFET('NM4', 'x105', 'x104', 'x118', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM13', 'x105', 'VB5', 'x45', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x111', 'VB1', 'x112', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x105', 'VB1', 'x114', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM5', 'x114', 'x105', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM7', 'x106', 'x105', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM13', 'VOUT1', 'x105', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM14', 'x105', 'VB4', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
