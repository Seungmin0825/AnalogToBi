...
circuit.MOSFET('NM4', 'x25', 'x71', 'x15', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM9', 'x40', 'x40', 0, 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.R('R3', 'x71', 'VSS', 1@u_kΩ)
circuit.R('R1', 'VDD', 'x36', 1@u_kΩ)
circuit.R('R2', 'VDD', 'x40', 1@u_kΩ)
circuit.R('R4', 'VOUT1', 'x71', 1@u_kΩ)
circuit.R('R6', 'VOUT1', 'x71', 1@u_kΩ)
