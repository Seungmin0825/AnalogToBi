...
circuit.MOSFET('NM4', 'x12', 'x12', 'x14', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'x2', 'x12', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
