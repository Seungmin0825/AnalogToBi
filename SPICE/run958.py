...
circuit.MOSFET('NM8', 'VDD', 'VSS', 'VOUT1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'VSS', 'VSS', 'x25', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM10', 'VIN1', 'VSS', 'x17', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM11', 'x17', 'VCLK1', 'VOUT1', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'VSS', 'VREF1', 'x25', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM5', 'x25', 'VSS', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM9', 'VSS', 'VSS', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'VSS', 'VSS', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM6', 'VSS', 'VDD', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
