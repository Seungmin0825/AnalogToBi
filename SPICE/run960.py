...
circuit.MOSFET('NM5', 'x16', 'VB2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'VB2', 'VREF1', 'x16', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM11', 'VB4', 'VB2', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM12', 'VDD', 0, 'VSS', 0, model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM9', 'VB4', 'VB2', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
