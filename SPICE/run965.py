...
circuit.MOSFET('NM2', 'x112', 'VB5', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM4', 'x111', 'x10', 'x112', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM1', 'x107', 'VB5', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('NM3', 'VB5', 'x10', 'x107', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM15', 'VB5', 'VB7', 'x112', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x111', 'VB3', 'x102', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'VB5', 'VB3', 'x100', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM11', 'VB5', 'VB6', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
