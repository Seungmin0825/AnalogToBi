...
circuit.MOSFET('NM4', 'VB1', 'x9', 'x14', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM5', 'x14', 'VB3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('NM8', 'x32', 'VB3', 'VSS', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'x3', 'VB1', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'VB3', 'x21', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM9', 'VB2', 0, 'VDD', 0, model='pmos_model', w=50e-6, l=1e-6)
