...
circuit.MOSFET('PM2', 'x13', 'VREF1', 'x24', 'x46', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM1', 'x18', 'x45', 'x24', 'x46', model='pmos_model', w=50e-6, l=1e-6)
