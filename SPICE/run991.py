...
circuit.MOSFET('NM4', 'x23', 'x2', 'x14', 'VSS', model='nmos_model', w=50e-6, l=1e-6)
...
circuit.MOSFET('PM1', 'x4', 'x23', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
circuit.MOSFET('PM2', 'x47', 'x21', 'VDD', 'VDD', model='pmos_model', w=50e-6, l=1e-6)
