...
for idx in training_indices:
    training_total_data.append(np.load(sequence_total_data_paths[idx], allow_pickle=True))

# Load validation data
for idx in validation_indices:
    validation_total_data.append(np.load(sequence_total_data_paths[idx], allow_pickle=True))
